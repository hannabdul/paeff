...
def read_data(test_path_face='./voxceleb1_feats/face_veriflist_test_random_unseenunheard.csv', test_path_voice='./voxceleb1_feats/voice_veriflist_test_random_unseenunheard.csv'):
    
    #test_file_face = './voxceleb1_feats/face_veriflist_test_random_unseenunheard.csv'
    #test_file_voice = './voxceleb1_feats/voice_veriflist_test_random_unseenunheard.csv'

    print('Reading Test Faces')
    face_test = pd.read_csv(test_path_face, header=None)
    #face_test = face_test.iloc[1: , :] # drop first row

    print('Reading Test Voices')
    voice_test = pd.read_csv(test_path_voice, header=None)
    #voice_test = voice_test.iloc[1: , :] # drop first row
